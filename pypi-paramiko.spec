...
Source0  : https://files.pythonhosted.org/packages/0b/6a/1d85cc9f5eaf49a769c7128039074bbb8127aba70756f05dfcf4326e72a1/paramiko-3.4.1.tar.gz
...
%prep
%setup -q -n paramiko-3.4.1
cd %{_builddir}/paramiko-3.4.1
pushd ..
cp -a paramiko-3.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723472524
